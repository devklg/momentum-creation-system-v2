...
describe('S2.7 runtime turn coordinator static governance boundary', () => {
  it('keeps coordinator imports away from stores, GraphRAG, Gateway fallback, persistence, and retrieval helpers', () => {
  ...
  it('keeps coordinator executable code away from direct stores, GraphRAG, Gateway fallback, raw retrieval, and packet assembly', () => {
  ...
  it('verifies the Gateway HTTP fallback stays retired (ACR-0009) outside coordinator source', () => {
