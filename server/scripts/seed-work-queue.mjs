...
const Q = [
  ...
  { id: 'wq_michael_schedule', surface: 'team', order: 41, status: 'partial',
    title: 'Michael interview surface + scheduler',
    evidence: 'apps/team michael-schedule.tsx; server domain/michael-schedule.ts, routes/michael.ts, telnyx webhook #102', note: 'Scheduler + Telnyx call origination + webhook wired. 3-state UI (Awaiting/In-progress/Complete) + live transcript view PENDING. Needs Michael 5 prompts.', deps: ['michael_prompts', 'michael_call_timing'] },
