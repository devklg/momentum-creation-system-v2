...
const ITEMS: ThreeKnowledgeSeedItem[] = [
  ...
  {
    path: 'compensation/III-Compensation-Starter-Guide-2026-07-30.md',
    title: 'THREE Compensation Starter Teaching Guide and Matching Cheat Sheet',
    domain: 'training',
    language: 'en',
    topicTags: [
      'compensation',
  ...
  {
    path: 'products/three-shopping-product-capture-2026-07-30-ocr.json',
    title: 'THREE Shopping Product Capture (2026-07-30 OCR dataset)',
    domain: 'training',
    language: 'en',
    topicTags: [
      'shopping',
