...
- [ ] 134. **Knowledge:** Add source conflict detection. *(Proposed ACR-0028 reconciles the ratified requirement to flag unresolved contradictions with the missing detector, evidence, privacy, activation, and resolution contracts. The recommended boundary is pre-write, content-minimized, review-only detection that never treats semantic similarity as truth, never auto-resolves or supersedes, and blocks new activation on unresolved/incomplete evidence. Awaiting Kevin's approval or changes.)*
