...
- [ ] 134. **Knowledge:** Add source conflict detection. *(ACR-0028 proposed: a bounded, deterministic, content-free observer for approved-source identity, authority, duplicate, and resource-projection conflicts, surfaced as a Kevin-only admin warning. The proposal authorizes no source mutation, semantic LLM judgment, correction, lifecycle change, or supersession; implementation awaits Kevin's explicit approval.)*
