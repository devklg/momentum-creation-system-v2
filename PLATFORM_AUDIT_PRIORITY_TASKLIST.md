...
- [ ] 131. **Admin:** Add pagination and index awareness for high-volume admin views. *(Blocked behind proposed ACR-0025. Current admin BA, prospect, event, and resource row sets use incompatible capped/full-array read patterns, and the generated index catalog is planning evidence rather than proof of installed indexes. Kevin must approve the cursor, compatibility, totals, and index-authority decisions before implementation.)*
