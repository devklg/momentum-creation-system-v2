...
- [ ] 133. **Chroma:** Add Chroma re-index tooling and age-out policy. *(ACR-0027 proposes a manifest-governed, dry-run-first operator CLI that rebuilds only from canonical Mongo through existing projectors and ages out only canonically proven inactive projections. The live stack has 60 collections versus 53 in the app catalog; seven unowned collections remain excluded. No calendar TTL or live mutation is authorized. Awaiting Kevin's ACR approval.)*
