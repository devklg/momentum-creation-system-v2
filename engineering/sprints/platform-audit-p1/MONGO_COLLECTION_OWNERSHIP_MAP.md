...
- Generated: 2026-07-11T22:27:41.190Z
- Collections: 65
- Unclassified: 0
...
| `tmag_prospect_callback_requests` | Prospect invitation and PMV flow | Prospect / invitation domain | com + team + admin | mixed | permissive_mongoose_schema | yes | 6 |
...
| `tmag_prospect_crm_records` | Prospect CRM and follow-up trail | CRM domain | team + admin | mixed | permissive_mongoose_schema | yes | 7 |
...
| `tmag_prospect_timeline_events` | Prospect CRM and follow-up trail | CRM domain | team + admin | mixed | permissive_mongoose_schema | yes | 2 |
...
| `tmag_vm_bulk_leads` | VM/RVM import, ownership, queue, and provider events | VM/RVM domain | admin + workers | operational | permissive_mongoose_schema | yes | 14 |
...
| `tmag_vm_delivery_events` | VM/RVM import, ownership, queue, and provider events | VM/RVM domain | admin + workers | operational | permissive_mongoose_schema | yes | 1 |
