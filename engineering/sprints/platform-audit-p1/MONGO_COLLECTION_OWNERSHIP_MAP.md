...
- Generated: 2026-09-04T13:07:41.956Z
- Collections: 76
- Unclassified: 0
...
| `MCS_KNOWLEDGE_BASE_SOURCE_COLLECTION` | Dynamic helper expression | Owning caller resolves at runtime | system | mixed | permissive_mongoose_schema | expression | 2 |
...
| `team_magnificent_members` | Membership identity and sponsor governance | Admin / BA identity | team + admin | mixed | explicit_mongoose_schema | yes | 62 |
...
| `tmag_prospect_htank_counters` | Holding tank, prospect account, and re-entry | Prospect access / pool placement | com + admin | mixed | permissive_mongoose_schema | yes | 7 |
