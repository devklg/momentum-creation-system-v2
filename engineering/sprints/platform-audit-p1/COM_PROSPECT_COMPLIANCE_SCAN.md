...
| `pmv_language_context` | 33 | Prospect-facing PMV language is People, Momentum, Volume, and Checks. |
...
| `glp_three_product_context` | `apps/com/src/routes/tm-prospect-dashboard/tm-prospect-dashboard.tsx:127` | Does GLP-THREE actually work? |
| `glp_three_product_context` | `apps/com/src/routes/tm-prospect-dashboard/tm-prospect-dashboard.tsx:131` | GLP-THREE is the product you just saw. Team Magnificent is a team of people building businesses around sharing it — and this page is their work, visible. |
...
| `pmv_language_context` | `apps/com/src/routes/com-homepage.tsx:21` | Team Magnificent is a community of independent brand ambassadors sharing health and wellness — physically and financially — with a step-by-step system for people exploring work-from-home opportunities. |
...
| `pmv_language_context` | `apps/com/src/routes/tm-prospect-dashboard/tm-prospect-dashboard.tsx:24` | So the question is simple. Do you want to be in front of these people as they say yes, with more of them on your team — or wait, and be placed underneath, as part of their team and ours? |
| `pmv_language_context` | `apps/com/src/routes/tm-prospect-dashboard/tm-prospect-dashboard.tsx:28` | Paul Barrios earned millions over seventeen years in his last company. He wasn’t the first to hear about it. The opportunity went first to a big networker, who said no. About ninety days later that man changed his mind and joined — and was placed onto Paul’s team. Paul went on to build 300,000 people. The man who waited was one of them. He did well. And he still said, years later, that those ninety days were very costly and that he should have said yes sooner. |
| `pmv_language_context` | `apps/com/src/routes/tm-prospect-dashboard/tm-prospect-dashboard.tsx:113` | people arrived |
| `pmv_language_context` | `apps/com/src/routes/tm-prospect-dashboard/tm-prospect-dashboard.tsx:131` | GLP-THREE is the product you just saw. Team Magnificent is a team of people building businesses around sharing it — and this page is their work, visible. |
| `pmv_language_context` | `apps/com/src/routes/tm-prospect-dashboard/tm-prospect-dashboard.tsx:156` | Plainly: you&rsquo;re being offered the chance to build a business of your own. As a builder, you&rsquo;d earn from real work: sharing the product with people who want it, and helping people who want to build do the same — with this system working alongside you. It is not a job, an investment, or a lottery ticket. It is a business, with no guarantees and results that follow effort. |
| `pmv_language_context` | `apps/com/src/routes/tm-prospect-dashboard/tm-prospect-dashboard.tsx:185` | You are not being asked to evaluate a business without the people and support around it. |
| `pmv_language_context` | `apps/com/src/routes/tm-prospect-dashboard/tm-prospect-dashboard.tsx:189` | People Momentum Volume Checks |
| `pmv_language_context` | `apps/com/src/routes/tm-prospect-dashboard/tm-prospect-dashboard.tsx:190` | Checks |
| `pmv_language_context` | `apps/com/src/routes/tm-prospect-dashboard/tm-prospect-dashboard.tsx:190` | Momentum |
| `pmv_language_context` | `apps/com/src/routes/tm-prospect-dashboard/tm-prospect-dashboard.tsx:190` | People |
| `pmv_language_context` | `apps/com/src/routes/tm-prospect-dashboard/tm-prospect-dashboard.tsx:190` | Volume |
| `pmv_language_context` | `apps/com/src/routes/tm-prospect-dashboard/tm-prospect-dashboard.tsx:267` | THE SYSTEM YOU&apos;VE BEEN PLACED INSIDE — What you&apos;re looking at isn&apos;t a webpage — it&apos;s a live view into a working system built for one thing: helping people build a business without doing it alone. The line you&apos;re watching is real. Every arrival is a real person, added by a real team member, right now. When you join, that same machinery starts working alongside you: an AI-guided onboarding that captures your why and builds your launch plan around it, a daily success coach that keeps you moving, a 72-hour launch mission with the whole system pointed at your first two wins, weekly live webinars — with last week&apos;s always available on replay — and a placement engine that puts the team&apos;s momentum next to your own effort. Most opportunities hand you a starter kit and a phone. This one hands you an operating system. It won&apos;t do the work for you — nothing real does. But you&apos;ll never work without it. |
| `pmv_language_context` | `apps/com/src/routes/tm-prospect-dashboard/tm-prospect-dashboard.tsx:275` | Building alone is why most people quit. So nobody here builds alone. |
| `pmv_language_context` | `apps/com/src/routes/tm-prospect-dashboard/tm-prospect-dashboard.tsx:283` | Built by magnificent people. Driven by purpose. |
...
| `placement_demo_context` | `apps/com/src/routes/tm-prospect-dashboard/tm-prospect-dashboard.tsx:22` | When you join — and when they join — decides your placement, in real time, and whether you’re in front of them or behind them. |
| `placement_demo_context` | `apps/com/src/routes/tm-prospect-dashboard/tm-prospect-dashboard.tsx:23` | We make no promises about who is placed where. What we know is this: every prospect has to be placed, and once a position is filled, the next one takes the next available spot. That’s it. |
| `placement_demo_context` | `apps/com/src/routes/tm-prospect-dashboard/tm-prospect-dashboard.tsx:24` | So the question is simple. Do you want to be in front of these people as they say yes, with more of them on your team — or wait, and be placed underneath, as part of their team and ours? |
| `placement_demo_context` | `apps/com/src/routes/tm-prospect-dashboard/tm-prospect-dashboard.tsx:28` | Paul Barrios earned millions over seventeen years in his last company. He wasn’t the first to hear about it. The opportunity went first to a big networker, who said no. About ninety days later that man changed his mind and joined — and was placed onto Paul’s team. Paul went on to build 300,000 people. The man who waited was one of them. He did well. And he still said, years later, that those ninety days were very costly and that he should have said yes sooner. |
| `placement_demo_context` | `apps/com/src/routes/tm-prospect-dashboard/tm-prospect-dashboard.tsx:29` | That’s not hype. That’s how it went. So investigate this opportunity thoroughly — and do it quickly. Your position in the line is yours to keep the moment you say yes. |
| `placement_demo_context` | `apps/com/src/routes/tm-prospect-dashboard/tm-prospect-dashboard.tsx:103` | The presentation told you something unusual: while you watched, you were placed in our team&rsquo;s line so we could show you something real. This is it. Every circle is a real person and every data-bearing movement is a real event. Nothing on this screen is a simulation. |
| `placement_demo_context` | `apps/com/src/routes/tm-prospect-dashboard/tm-prospect-dashboard.tsx:164` | Whether it becomes a new financial future depends on the same thing every real business depends on — the work you put in. The line shows team activity; it promises neither placement nor results. |
| `placement_demo_context` | `apps/com/src/routes/tm-prospect-dashboard/tm-prospect-dashboard.tsx:181` | The working method is visible here: share, real response, live placement, and human follow-up. |
