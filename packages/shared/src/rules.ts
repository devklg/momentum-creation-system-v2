...
export const MCS_STANDING_RULE_SPONSOR_IMMUTABLE =
...
export const MCS_STANDING_RULE_NO_PROGRAMMATIC_THREE_HANDOFF =
...
export const MCS_STANDING_RULE_POOL_MONOTONIC =
...
export const MCS_STANDING_RULE_FLUSH_WINDOW_DAYS = 56;
