...
Locked Chat #130. Closes the prospect-re-entry open question from Chat #125 (Part 5). Layer 1 (completion-interrupt fix + presentation↔dashboard navigation) shipped Chat #126. Layer 2 (temporary account) and Layer 3 (`.com` login surface) are described here.
