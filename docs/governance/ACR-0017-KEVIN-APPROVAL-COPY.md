...
- Validates the continuation's declared `origin/main` base and requires its tracked revision to be no more than 10 commits behind current `origin/main` before injecting its task pointer.
